...
| **EW-SEW** [(Hwang et al., 2015)](https://aclanthology.org/N15-1022/) | EN | Wikipedia | Comparable | Sent | 150,000 full and 130,000 partial matches | 1 | [Link](https://web.archive.org/web/20150906192742/http://ssli.ee.washington.edu/tial/projects/simplification/) (Archived, pre-processed version available [here](https://github.com/senisioi/NeuralTextSimplification)) |
...
| **Wikipedia (with context)** [(Sun et al., 2020)](https://doi.org/10.18653/v1/2020.coling-main.121) | EN | Wikipedia | Comparable | Sent | 116,020 sentences with context (includes preceding and following sentence) | 1 | [Link](https://github.com/rlsnlp/document-context-to-sentence-simplification) |
| **D-Wikipedia** [(Sun et al., 2021)](https://doi.org/10.18653/v1/2021.emnlp-main.630) | EN | Wikipedia | Comparable | Doc | 143,546 article pairs | 1 | [Link](https://github.com/RLSNLP/Document-level-text-simplification/tree/main/Dataset) |
...
| **SWiPE** [(Laban et al., 2023)](https://doi.org/10.18653/v1/2023.acl-long.596) | EN | Wikipedia | Comparable | Doc | 145,161 article revision pairs, anntations of fine-grained edit operations on ~5000 articles | 1 | [Link](https://github.com/Salesforce/simplification) |
...
| **CLARA-MeD** [(Campillos-Llanos et al., 2022)](http://journal.sepln.org/sepln/ojs/ojs/index.php/pln/article/view/6439) | ES | Medical | Comparable | Doc | 24298 comparable documents and 3800 parallel sentences | | [Link](https://digital.csic.es/handle/10261/269887) |
...
| **SimpMedLexSp** [(Campillos-Llanos et al., 2024)](https://aclanthology.org/2024.lrec-main.1216.pdf) | ES | Medical | Parallel | Lex | >14000 pairs of medical terms and the corresponding simplified synonym/definition. | 1 | [Link](https://digital.csic.es/handle/10261/349662) |
| **JASMINE** [(Horiguchi et al., 2024)](https://aclanthology.org/2024.naacl-srw.23/) | JA | Medical | Parallel | Sent | 1425 sentences (0/425/1000 train/val/test) | 1 | [Link](https://github.com/OnizukaLab/JASMINE) (available on request) |
